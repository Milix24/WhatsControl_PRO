    ...
    clients.forEach((c, i) => {
        ...
        if(matchesSearch && matchesFilter) {
            ...
            card.innerHTML = `
                ...
                <div class="actions">
                    <button class="btn-action btn-ws" onclick="window.open('https://wa.me/${c.phone}')" title="WhatsApp">
...
function clearCycle() {
    if(confirm("🛑 Esto borrará toda la lista. ¿Continuar?")) {
